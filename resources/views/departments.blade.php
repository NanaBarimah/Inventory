...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            @include('layouts.navbar', ['page_title' => 'Departments List'])
                    ...
                    <div class="col-md-10 center">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="inline-block">Departments List</h4>
                                <a href="#" class="btn btn-purple pull-right" data-toggle="modal" data-target="#addDepartmentModal">Add New</a>
                            </div>
                            <div class="card-body">
                                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    @foreach($departments as $department)
                                        <tr>
                                            ...
                                            <td>
                                                <span data-toggle="modal" data-target="#editDepartmentModal" data-id="{{$department->id}}" data-name="{{$department->name}}">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <h5 class="modal-title margin-bottom-10" id="addDepartmentLabel">New Department</h5>
                    <form method="post" action="#" id="add_new_dept_form">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Department Name" name="name" id="dept_name"/>
                            <div class="col-sm-12" style="margin-top: 12px;">
                               <h6 class="subtitle">Department Head</h6>
    ...
    <div class="modal fade" id="editDepartmentModal" tabindex="-1" role="dialog" aria-labelledby="editDepartmentLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <h5 class="modal-title margin-bottom-10" id="editDepartmentLabel">Edit Department</h5>
                    <form method="post" action="#" id="edit_dept_form">
                        <div class="form-group">
                            <input type="text" class="form-control normal-radius" placeholder="Department Name" name="name" id="edit_dept_name"/>
    ...
    <script>
        ...
        $('#editDepartmentModal').on('hide.bs.modal', function(e){
        ...
        $('#edit_dept_form').on('submit', function(e){
            ...
            request = $.ajax({
                ...
                success: function(data, status){
                    $('#btn_edit').html('Save');
                    presentNotification('Department updated', 'info', 'top', 'right');     
                    setTimeout(function(){
                        location.reload()
                    }, 1700);             
                },
                error: function(xhr, desc, err){
                    $('#btn_edit').html('Save');
                    presentNotification('Could not update the Department', 'danger', 'top', 'right');
                }
            });
        });

        $('#edit_dept_form input').on('input', function(){
