...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            @include('layouts.navbar', ['page_title' => 'Maintenance Approval'])
                                ...
                                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    @foreach($maintenances as $maintenance)
                                        <tr class="uppercase">
                                            ...
                                            <td>
                                                <input type="checkbox" class="bootstrap-switch"  id="toggle-{{$maintenance->id}}" <?php if($maintenance->is_hospital_approved == 1){echo 'checked';}?>
    ...
    <script>
        ...
        function approve(el, maintenance){
            ...
            var form_data = "id="+id+"&is_hospital_approved="+is_hospital_approved;
                
            $.ajax({
                url : '/api/maintenances/approve',
                method: 'put',
                data : form_data,
