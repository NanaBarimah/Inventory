                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                               Your request titled <b>"{{$request->title}}"</b> on <b>{{date('jS F, Y', strtotime($request->created_at))}}</b> was declined. The following was the reason given for this decision. <br/><br/>
                                               <code>
                                                {{$request->reason}}
                                               </code> 
                                            </td>
                                        ...
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                               Follow the link at the bottom of this email to edit the request if required. 
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center" style="border-radius: 3px;" bgcolor="#256F9C">
                                                <a href="{{URL::route('request.show', $request->id)}}" target="_blank" style="font-size: 15px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 10px 20px; border: 1px solid #256F9C; display: inline-block;" class="mobile-button">View Request &rarr;</a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
