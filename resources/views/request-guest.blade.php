@extends('layouts.empty-dashboard', ['page_title' => 'Add Work Order Request'])
@section('content')
<div class="content">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 pr-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="requester_email" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-md-4 pr-1">
                                <div class="form-group">
                                    <label><b>Phone number</b></label>
                                    <input type="text" name="requester_number" class="form-control" required/>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
...
@section('scripts')
    ...
    <script>
        ...
        $("#add_request_form").on("submit", function(e){
            ...
            data.append("hospital_id", '{{$hospital->id}}');
            data.append("request_link", '{{$hospital->setting->request_link}}');
            let btn = $(this).find('[type="submit"]');
            submit_file_form("/api/request/guest/add", "post", data, undefined, btn, true);
        });
