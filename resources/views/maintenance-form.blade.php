                                        ...
                                        <div class="tab-pane show active" id="about">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-lg-10">
                                                    ...
                                                    <div class="row">
                                                        <select class="col-sm-12 selectpicker" data-style="btn btn-purple btn-round"
                                                                title="Equipment code" name="equipment_code" data-live-search = "true" data-show-subtext="true" required>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="choice" data-toggle="wizard-radio">
                                                                <input type="radio" name="type" value="Planned Maintenance">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="choice" data-toggle="wizard-radio">
                                                                <input type="radio" name="type" value="Corrective Maintenance">
                                                                <div class="icon">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="choice" data-toggle="wizard-radio">
                                                                <input type="radio" name="type" value="Emergency Maintenance">
                                                                <div class="icon">
                                                        ...
                                                        <div class="col-sm-12 col-md-4 hideable">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control datepicker" name="date_reported"
                                                                    required="true" placeholder="Date Reported">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" value="{{Auth::user()->id}}" name="mtce_officer"/>
